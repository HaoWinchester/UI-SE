...
export const agentRegistry: Record<AgentName, AgentDefinition> = {
  ...
  "frontend-agent": {
    ...
    readScopes: ["docs", "artifacts/ui", "artifacts/specs", "artifacts/code-workspace", "skills/frontend-agent"],
  ...
  "backend-agent": {
    ...
    readScopes: ["docs", "artifacts/specs", "artifacts/code-workspace", "skills/backend-agent"],
    writeScopes: ["artifacts/code-workspace"],
    tools: ["repo-read", "repo-write", "repo-writer", "model-client"],
  },
  "db-agent": {
    ...
    readScopes: ["docs", "artifacts/specs", "artifacts/code-workspace", "skills/db-agent"],
    writeScopes: ["artifacts/code-workspace"],
    tools: ["repo-read", "repo-write", "repo-writer", "model-client"],
  },
  "dev-agent": {
  ...
  "acceptance-agent": {
    ...
    readScopes: ["artifacts", "docs", "skills/acceptance-agent"],
    writeScopes: [],
    tools: ["repo-read", "job-store"],
  },
  "deploy-agent": {
